...
from core.rest_framework.groups import create_groups, set_groups_to_users
...
class TestAuthMixin(object):
    ...
    def set_user(self, username=TEST_USER1, password=CURRENT_PASSWORD):
        self.client.credentials(
            HTTP_AUTHORIZATION='Token ' + self.get_token(username, password))
...
#         if self.api_version and self.api_version == settings.RHYTHM[
#             'API_VERSION']:
